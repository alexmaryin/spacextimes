...
public abstract class Hilt_CrewDetailFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_CrewDetailFragment() {
    super();
  }

  Hilt_CrewDetailFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CrewDetailFragment_GeneratedInjector) this.generatedComponent()).injectCrewDetailFragment(UnsafeCasts.<CrewDetailFragment>unsafeCast(this));
    }
  }
