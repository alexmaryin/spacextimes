...
public class FragmentMainBindingImpl extends FragmentMainBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.spaceXViewModel == variableId) {
            setSpaceXViewModel((ru.alexmaryin.spacextimes_rx.ui.view.viewmodel.SpaceXViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setSpaceXViewModel(@Nullable ru.alexmaryin.spacextimes_rx.ui.view.viewmodel.SpaceXViewModel SpaceXViewModel) {
        this.mSpaceXViewModel = SpaceXViewModel;
    }
