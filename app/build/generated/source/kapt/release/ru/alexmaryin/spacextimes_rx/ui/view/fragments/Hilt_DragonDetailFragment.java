...
public abstract class Hilt_DragonDetailFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_DragonDetailFragment() {
    super();
  }

  Hilt_DragonDetailFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((DragonDetailFragment_GeneratedInjector) this.generatedComponent()).injectDragonDetailFragment(UnsafeCasts.<DragonDetailFragment>unsafeCast(this));
    }
  }
